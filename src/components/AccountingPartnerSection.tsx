...
export const AccountingPartnerSection: React.FC = () => {
  return (
    <section id="contabilidade" className="py-20 sm:py-24 px-4 sm:px-6 lg:px-8 bg-[#FAF8F5]">
      <div className="max-w-7xl mx-auto">
        
        {/* Header */}
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 mb-3">
            <Handshake className="w-4 h-4 text-[#4F6D46]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          {/* Contador Card */}
          <div className="rounded-2xl p-8 bg-white/80 border border-[#EAE7DE] shadow-sm flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between gap-3 mb-6">
                <span className="text-xs font-mono font-bold tracking-wider text-[#5C3A1A] uppercase bg-[#FAF8F5] px-3.5 py-1 rounded-md border border-[#EAE7DE]">
                  CONFORMIDADE &amp; TRIBUTOS
                </span>
                <Calculator className="w-6 h-6 text-[#5C3A1A]/70" />
              </div>

              <h3 className="text-xl font-bold text-[#2C1810] mb-3">
                O que o seu Contador faz (e faz com excelência):
              </h3>
              <p className="text-xs sm:text-sm text-[#5C3A1A]/75 mb-6 leading-relaxed">
                Garante que a sua empresa cumpra todas as exigências do Fisco com máxima segurança jurídica.
              </p>

              <ul className="space-y-3 mb-6 text-xs sm:text-sm text-[#2C1810]/85 font-medium">
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#D1B688] shrink-0 mt-0.5" />
            ...
            <div className="pt-4 border-t border-[#EAE7DE] text-xs text-[#5C3A1A]/70 font-medium">
              Papel essencial para a segurança fiscal e jurídica do negócio.
            </div>
          </div>

          {/* OECO Card (Highlighted) */}
          <div className="rounded-2xl p-8 bg-[#1C1815] text-[#FAF8F5] border border-[#D1B688]/40 shadow-xl relative overflow-hidden flex flex-col justify-between">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#4F6D46]/15 rounded-full blur-2xl pointer-events-none -mr-16 -mt-16"></div>

            <div className="relative z-10">
              <div className="flex items-center justify-between gap-3 mb-6">
                <span className="text-xs font-mono font-bold tracking-wider text-[#D1B688] uppercase bg-[#FAF8F5]/10 px-3.5 py-1 rounded-md border border-[#D1B688]/30">
                  OPERAÇÃO &amp; ESTRATÉGIA DE CAIXA
                </span>
                <FileSpreadsheet className="w-6 h-6 text-[#D1B688]" />
              </div>

              <h3 className="text-xl font-bold text-[#FAF8F5] mb-3">
                O que a OECO assume no seu dia a dia:
              </h3>
              <p className="text-xs sm:text-sm text-[#FAF8F5]/75 mb-6 leading-relaxed">
                Entra na trincheira da sua operação para cuidar da rotina de contas e proteger o lucro real dos seus contratos.
              </p>

              <ul className="space-y-3 mb-6 text-xs sm:text-sm text-[#FAF8F5]/90 font-medium">
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#D1B688] shrink-0 mt-0.5" />
            ...
            <div className="pt-4 border-t border-[#FAF8F5]/15 text-xs text-[#D1B688] font-semibold relative z-10 flex items-center gap-2">
