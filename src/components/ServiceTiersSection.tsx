...
export const ServiceTiersSection: React.FC = () => {
  return (
    <section id="solucoes" className="py-20 sm:py-24 px-4 sm:px-6 lg:px-8 bg-[#FAF8F5]">
          ...
          <div className="lg:col-span-5 rounded-3xl p-8 sm:p-10 bg-white border border-[#EAE7DE] shadow-md hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="w-12 h-12 rounded-2xl bg-[#FAF8F5] border border-[#EAE7DE] flex items-center justify-center text-[#5C3A1A]">
                  <Briefcase className="w-6 h-6" />
                </div>
                <span className="text-xs font-semibold uppercase tracking-wider text-[#5C3A1A] bg-[#FAF8F5] px-3.5 py-1 rounded-full border border-[#EAE7DE]">
                  Rotina Impecável
                </span>
              </div>
              ...
              <p className="text-xs font-semibold text-[#6B7F5A] mb-4">
                Para empresas com faturamento a partir de R$ 100k/mês
              </p>
              <p className="text-xs sm:text-sm text-[#5C3A1A]/80 mb-8 leading-relaxed">
              ...
              <div className="space-y-3.5 mb-8">
                ...
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5">
                    <div className="w-4 h-4 rounded-full bg-[#6B7F5A]/20 text-[#6B7F5A] flex items-center justify-center shrink-0 mt-0.5">
                      <Check className="w-3 h-3 stroke-[3]" />
                    </div>
                    <span className="text-xs sm:text-sm text-[#2C1810]/85 font-medium">{item}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <div className="p-4 rounded-xl bg-[#FAF8F5] border border-[#EAE7DE] mb-6">
                <p className="text-xs text-[#5C3A1A] font-medium leading-snug">
              ...
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 py-4 px-6 rounded-xl bg-[#2C1810] hover:bg-[#5C3A1A] text-white font-bold text-xs tracking-wide transition-colors shadow-md"
              >
          ...
          <div className="lg:col-span-7 rounded-3xl p-8 sm:p-12 bg-[#1C1815] text-[#FAF8F5] border-2 border-[#D1B688] shadow-2xl relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="relative z-10">
              <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
                <div className="w-12 h-12 rounded-2xl bg-[#D1B688]/20 border border-[#D1B688]/50 flex items-center justify-center text-[#D1B688]">
                  <Building2 className="w-6 h-6" />
                </div>
                <div className="flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-[#D1B688] text-[#1C1815] text-xs font-bold uppercase tracking-wider shadow-sm">
                  <Star className="w-3.5 h-3.5 fill-current" />
                  <span>Destaque · Construtoras &amp; Projetos</span>
                </div>
              </div>

              <h3 className="text-2xl sm:text-3xl font-extrabold text-[#FAF8F5] mb-2">
                BPO Financeiro Estratégico
              </h3>
              <p className="text-xs sm:text-sm font-semibold text-[#D1B688] mb-4">
                Para construtoras e contratos com orçamento acima de R$ 3 milhões
              </p>
              <p className="text-xs sm:text-sm text-[#FAF8F5]/80 mb-8 leading-relaxed max-w-xl">
              ...
              <div className="space-y-3.5 mb-8">
                ...
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5">
                    <div className="w-4 h-4 rounded-full bg-[#D1B688] text-[#1C1815] flex items-center justify-center shrink-0 mt-0.5 font-bold">
                      <Check className="w-3 h-3 stroke-[3]" />
                    </div>
                    <span className="text-xs sm:text-sm text-[#FAF8F5]/90 font-medium">{item}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="relative z-10">
              <div className="p-4 rounded-xl bg-[#FAF8F5]/10 border border-[#D1B688]/30 mb-6 backdrop-blur-sm">
                <p className="text-xs text-[#FAF8F5] font-medium leading-snug">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center gap-2 py-4 px-6 rounded-xl bg-[#D1B688] hover:bg-[#b89b6c] text-[#1C1815] font-extrabold text-sm tracking-wide transition-all shadow-lg hover:shadow-xl hover:scale-[1.01]"
              >
