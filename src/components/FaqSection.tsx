...
export const FaqSection: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-20 sm:py-24 px-4 sm:px-6 lg:px-8 bg-[#FAF8F5]">
      <div className="max-w-4xl mx-auto">
        
        {/* Header */}
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 mb-3">
            <HelpCircle className="w-4 h-4 text-[#6B7F5A]" />
          ...
          <p className="text-xs sm:text-sm text-[#5C3A1A]/80 max-w-xl mx-auto">
              ...
              <div
                ...
                className={`rounded-2xl border transition-all duration-200 overflow-hidden ${
                  isOpen
                    ...
                    : 'bg-white/70 border-[#EAE7DE] hover:border-[#D1B688]/60 hover:bg-white'
                }`}
              >
                <button
                  type="button"
                ...
                {isOpen && (
                  <div className="px-6 pb-6 pt-1 text-xs sm:text-sm text-[#5C3A1A]/85 leading-relaxed border-t border-[#FAF8F5] animate-in fade-in duration-200">
                    {item.a}
                  </div>
                )}
              </div>
        ...
        <div className="mt-12 text-center p-8 rounded-2xl bg-[#F4EFEA]/80 border border-[#EAE7DE]">
          <p className="text-sm font-bold text-[#2C1810] mb-1">
            Ficou com alguma dúvida específica sobre o seu modelo de obra ou negócio?
          </p>
          <p className="text-xs text-[#5C3A1A]/75 mb-5">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#2C1810] hover:bg-[#5C3A1A] text-white text-xs font-bold transition-colors shadow-sm"
          >
