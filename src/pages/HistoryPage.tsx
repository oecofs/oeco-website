...
import { ElevationSection, ElevationItem } from '../components/ElevationAct';
import { PresentationNavigator } from '../components/PresentationNavigator';

export const HistoryPage: React.FC = () => {
  return (
    <div className="bg-[#FAF8F5] text-[#292524] flex flex-col font-sans selection:bg-[#4F6D46] selection:text-white relative">
      
      {/* ========================================================================= */}
      {/* 1. HERO EDITORIAL DA FLORESTA & SUSTENTABILIDADE */}
      {/* ========================================================================= */}
      <section id="ato-hero" className="relative min-h-[85vh] flex items-center justify-center pt-32 pb-24 px-4 sm:px-6 lg:px-8 bg-[#112010] text-[#FAF8F5] overflow-hidden">
      ...
      {/* ========================================================================= */}
      {/* 2. A INQUIETAÇÃO NA TRINCHEIRA (Transição de Elevação Item a Item) */}
      {/* ========================================================================= */}
      <section id="ato-inquietacao" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-[#FAF8F5]">
        <div className="max-w-7xl mx-auto">
          <ElevationSection>
            {/* Título e Citação Centralizados no Topo */}
            <ElevationItem delay={0}>
              <div className="max-w-3xl mx-auto text-center mb-14 sm:mb-16">
                <h2 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold text-[#112010] tracking-tight mb-6 leading-tight">
                  Por que tantas empresas que vendem bem sangram no escuro?
                </h2>

                <blockquote className="p-5 sm:p-6 rounded-2xl bg-[#F2F5ED] border-l-4 border-[#4F6D46] text-[#112010] font-medium text-base sm:text-lg italic leading-relaxed text-left max-w-2xl mx-auto shadow-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
              ...
              {/* Coluna Esquerda: 3 Cards com Animação Escalonada */}
              <div className="lg:col-span-6 flex flex-col justify-between gap-5">
                {/* Ponto 1 */}
                <ElevationItem delay={150} className="flex-1 flex flex-col">
                ...
                {/* Ponto 2 */}
                <ElevationItem delay={300} className="flex-1 flex flex-col">
                  <div className="p-6 sm:p-7 rounded-3xl bg-white border border-[#EAE7DE] shadow-sm flex items-start gap-5 flex-1 hover:border-[#4F6D46]/40 hover:shadow-md transition-all">
                    <div className="w-12 h-12 rounded-2xl bg-[#F2F5ED] text-[#4F6D46] flex items-center justify-center shrink-0 mt-0.5">
                ...
                {/* Ponto 3 */}
                <ElevationItem delay={450} className="flex-1 flex flex-col">
                  <div className="p-6 sm:p-7 rounded-3xl bg-white border border-[#EAE7DE] shadow-sm flex items-start gap-5 flex-1 hover:border-[#4F6D46]/40 hover:shadow-md transition-all">
                    <div className="w-12 h-12 rounded-2xl bg-[#F2F5ED] text-[#4F6D46] flex items-center justify-center shrink-0 mt-0.5">
              ...
              {/* Coluna Direita: Imagem do Canteiro com Elevação */}
              <div className="lg:col-span-6 flex flex-col">
                <ElevationItem delay={250} className="flex-1 flex flex-col h-full">
                  <div className="rounded-3xl overflow-hidden border border-[#EAE7DE] shadow-xl bg-white group flex-1 flex flex-col h-full">
      ...
      {/* ========================================================================= */}
      <section id="ato-oecophylla" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-[#1B2E18] text-[#FAF8F5] relative overflow-hidden">
        {/* Glow ambient */}
          ...
          <ElevationSection>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-14 items-center">
              ...
              <div className="lg:col-span-6">
                <ElevationItem delay={150}>
                  <div className="rounded-3xl overflow-hidden border-2 border-[#D1B688]/40 shadow-2xl bg-[#112010] relative group">
                    <img
              ...
              {/* Narrative Content em Cascata */}
              <div className="lg:col-span-6 space-y-6">
                <ElevationItem delay={250}>
      ...
      {/* ========================================================================= */}
      <section id="ato-processo" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-[#FAF8F5]">
        <div className="max-w-5xl mx-auto">
          <ElevationSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Card 1 */}
              <ElevationItem delay={150}>
                <div className="p-8 rounded-3xl bg-white border border-[#EAE7DE] shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col justify-between">
                  <div>
      ...
      {/* ========================================================================= */}
      <section id="ato-fundador" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-[#F4F6F0]">
        <div className="max-w-7xl mx-auto">
          <ElevationSection>
            <ElevationItem delay={0}>
              <div className="max-w-3xl mx-auto text-center mb-16 sm:mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 items-center">
              ...
              {/* Timeline dos 4 Pilares da Trajetória em Cascata */}
      ...
      {/* ========================================================================= */}
      {/* 6. OS 4 ALICERCES DO ECOSSISTEMA FINANCEIRO OECO (Cascata nos Cards) */}
      {/* ========================================================================= */}
      <section id="ato-alicerces" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-[#112010] text-[#FAF8F5]">
        <div className="max-w-7xl mx-auto">
          <ElevationSection>
            <ElevationItem delay={0}>
              <div className="max-w-3xl mx-auto text-center mb-16 sm:mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 items-stretch">
              ...
              <ElevationItem delay={150} className="h-full flex flex-col">
                <div className="p-8 rounded-3xl bg-[#1A2E17] border border-[#D1B688]/30 flex flex-col justify-between items-center text-center hover:border-[#D1B688] transition-all duration-300 hover:shadow-xl group flex-1">
              ...
              <ElevationItem delay={300} className="h-full flex flex-col">
                <div className="p-8 rounded-3xl bg-[#1A2E17] border border-[#D1B688]/30 flex flex-col justify-between items-center text-center hover:border-[#D1B688] transition-all duration-300 hover:shadow-xl group flex-1">
                  <div className="w-full flex flex-col items-center">
                    <div className="w-14 h-14 rounded-2xl bg-[#D1B688]/15 border border-[#D1B688]/40 text-[#D1B688] flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
              ...
              <ElevationItem delay={450} className="h-full flex flex-col">
                <div className="p-8 rounded-3xl bg-[#1A2E17] border border-[#D1B688]/30 flex flex-col justify-between items-center text-center hover:border-[#D1B688] transition-all duration-300 hover:shadow-xl group flex-1">
                  <div className="w-full flex flex-col items-center">
                    <div className="w-14 h-14 rounded-2xl bg-[#D1B688]/15 border border-[#D1B688]/40 text-[#D1B688] flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
              ...
              {/* Pilar 4: Copa Viva */}
              <ElevationItem delay={600} className="h-full flex flex-col">
                <div className="p-8 rounded-3xl bg-[#1A2E17] border border-[#D1B688]/30 flex flex-col justify-between items-center text-center hover:border-[#D1B688] transition-all duration-300 hover:shadow-xl group flex-1">
                  <div className="w-full flex flex-col items-center">
                    <div className="w-14 h-14 rounded-2xl bg-[#D1B688]/15 border border-[#D1B688]/40 text-[#D1B688] flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
      ...
      {/* ========================================================================= */}
      <section id="ato-cta" className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 bg-[#FAF8F5] relative">
        <div className="max-w-5xl mx-auto">
          <ElevationSection>
            <div className="rounded-3xl bg-gradient-to-br from-[#112010] via-[#1B2E18] to-[#112010] text-[#FAF8F5] p-8 sm:p-14 lg:p-16 border-2 border-[#D1B688] shadow-2xl relative overflow-hidden text-center">
              {/* Ambient Lighting */}
      ...
      {/* Navegador e Controles Estilo PPT / Canva */}
